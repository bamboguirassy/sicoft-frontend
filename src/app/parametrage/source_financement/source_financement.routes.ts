...
const source_financementRoutes: Route = {
    path: 'sourceFinancement', children: [
        ...
        {path: 'new', component: SourceFinancementNewComponent, resolve: {types: MultipleTypeSourceFinancementResolver}},
        {
            ...
            resolve: {types: MultipleTypeSourceFinancementResolver, source_financement: OneSourceFinancementResolver}
        },
        {path: ':id/clone', component: SourceFinancementCloneComponent, resolve: {types: MultipleTypeSourceFinancementResolver, source_financement: OneSourceFinancementResolver}},
