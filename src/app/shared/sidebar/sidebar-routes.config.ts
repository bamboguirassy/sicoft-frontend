...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Config. Globale', icon: 'ft-settings', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            {
                path: '/group', title: "Groupes", icon: 'ft-layers', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], display: false
            },
            {
            ...
            {
                path: '/entite', title: "Entités", icon: 'ft-package', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], display: false
            },
            {
